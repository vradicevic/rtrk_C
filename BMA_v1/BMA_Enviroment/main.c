...
int main(void) {
	char* videoPath = "C:\\VISION_SDK_02_12_01_00\\vision_sdk\\tools\\network_tools\\bin\\YUV422YUYV_sekvence\\auticNew.yuv";
	char* vectorsPath = "/vectors0.bin";
	int ftr_num = 6;
	...
	int numOfMatches = blockMatchingTSS(vectors,currFrameY,prevFrameY,35);
	printf("Hello world");
